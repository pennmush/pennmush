...
sfmt_genrand_uint32(sfmt_t *sfmt)
{
  uint32_t r;
...
sfmt_genrand_uint64(sfmt_t *sfmt)
{
 ...
 */
inline static double
sfmt_genrand_real1(sfmt_t *sfmt)
{
 ...
 */
inline static double
sfmt_genrand_real2(sfmt_t *sfmt)
{
 ...
 */
inline static double
sfmt_genrand_real3(sfmt_t *sfmt)
{
 ...
 */
inline static double
sfmt_genrand_res53(sfmt_t *sfmt)
{
 ...
 */
inline static double
sfmt_to_res53_mix(uint32_t x, uint32_t y)
{
 ...
 */
inline static double
sfmt_genrand_res53_mix(sfmt_t *sfmt)
{
  uint32_t x, y;
