...
#define TRANSPARENTED                                                          \
  0x200             /* can look through exit to see next room,                 \
...
#define QUIET                                                                  \
  0x800                 /* On an object, will not emit 'set'                   \
...
#define MARKED                                                                 \
  0x10000 /* flag used to trace db checking of room                            \
           * linkages. */
#define NOWARN                                                                 \
  0x20000 /* Object will not cause warnings.                                   \
...
#define ENTER_OK                                                               \
  0x80000 /* object basically acts like a room with                            \
           * only one exit (leave), on players                                 \
           * means that items can be given freely, AND                         \
           * taken from!                                                       \
           */
#define VISUAL                                                                 \
  0x100000             /* People other than owners can see                     \
...
#define LOOK_OPAQUE                                                            \
  0x800000 /* Objects inside object will not be                                \
            * seen on a look.                                                  \
            */
#define INHERIT                                                                \
  0x1000000 /* Inherit objects can force their                                 \
...
#define AUDIBLE                                                                \
  0x10000000                  /* rooms are flagged as having emitter           \
...
#define GOING_TWICE                                                            \
  0x40000000 /* Marked for destruction, but                                    \
              * spared once. */
...
#define PLAYER_MYOPIC                                                          \
  0x10                      /* look at everything as if player                 \
                             * doesn't control it.                             \
                             */
#define PLAYER_NOSPOOF 0x20 /* sees origin of emits */
#define PLAYER_SUSPECT                                                         \
  0x40                       /* notifies of a player's name changes,           \
...
#define PLAYER_ANSI                                                            \
  0x400                           /* enable sending of ansi control            \
...
#define THING_Z_TEL                                                            \
  0x100 /* If set on ZMO players may only @tel                                 \
           within the zone */
...
#define ROOM_FLOATING                                                          \
  0x8                     /* room is not linked to rest of                     \
...
#define EXIT_CLOUDY                                                            \
  0x8 /* Looking through a cloudy transparent                                  \
