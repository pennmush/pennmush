/* rgb.h
 *
 * Generated by utils/genrgb.pl, this file contains mappings of color names to
 * RGB values. Used by markup.c for ansi() color.
 */
...
struct RGB_COLORMAP {
  ...
  int as_ansi;  /**< Color (0-7), +256 for highlight. Add 30 for FG color or 40
                   for BG color */
};

struct RGB_COLORMAP allColors[] = {{"aliceblue", 0xf0f8ff, 15, 263},
