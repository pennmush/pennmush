...
/* Append an accented string */
    ...
    char *replace_string2(const char *const old[2],
                          const char *const newbits[2],
                          const char *restrict string) __attribute_malloc__;
 ...
 * default value  */
    ...
    static inline const char *keystr_find(const char *restrict map,
                                          const char *restrict key)
{
...
keystr_find_d(const char *restrict map,
              const char *restrict key, const char *restrict deflt)
{
