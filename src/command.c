...
command_parse(dbref player, dbref cause, char *string, int fromport)
{
  ...
  command = static_cast<char *>(mush_malloc(BUFFER_LEN, "string_command"));
  swtch = static_cast<char*>(mush_malloc(BUFFER_LEN, "string_swtch"));
  ls = static_cast<char *>(mush_malloc(BUFFER_LEN, "string_ls"));
  rs = static_cast<char *>(mush_malloc(BUFFER_LEN, "string_rs"));
  switches = static_cast<char *>(mush_malloc(BUFFER_LEN, "string_switches"));
