...
lock_list lock_types[] = {
  ...
  {"From", TRUE_BOOLEXP, NULL, GOD, LF_PRIVATE, NULL},
  {"Pay", TRUE_BOOLEXP, NULL, GOD, LF_PRIVATE, NULL},
  {"Receive", TRUE_BOOLEXP, NULL, GOD, LF_PRIVATE, NULL},
  ...
  {"Open", TRUE_BOOLEXP, NULL, GOD, LF_PRIVATE, NULL},
  {"Filter", TRUE_BOOLEXP, NULL, GOD, LF_PRIVATE, NULL},
  {"InFilter", TRUE_BOOLEXP, NULL, GOD, LF_PRIVATE, NULL},
  {"DropIn", TRUE_BOOLEXP, NULL, GOD, LF_PRIVATE, NULL},
